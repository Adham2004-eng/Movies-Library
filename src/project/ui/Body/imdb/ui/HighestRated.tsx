...
import { useHighestRated } from "../Action/useHighestRated";
...
const HighestRated: React.FC = () => {

  const { highestRated, isLoading } = useHighestRated();
  ...
  return (
    ...
    >
      ...
      Highest Rated
            ...
            <StarIcon sx={{ color: "#F5C518", fontSize: 25 }} />
      </Typography>
